...
// Make CRM_Newsletter_ExtensionUtil available.
require_once __DIR__ . '/../../newsletter.civix.php';

// phpcs:disable PSR1.Files.SideEffects

// Add test classes to class loader.
addExtensionDirToClassLoader(__DIR__);
addExtensionToClassLoader('de.systopia.newsletter');
 ...
 */
function _newsletter_test_civicrm_container(ContainerBuilder $container): void {
}
