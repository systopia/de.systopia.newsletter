        ...
        <table class="form-layout-compressed">
          ...
          <tr class="crm-section">
            ...
            <td class="content">
              ...
              <div class="description">
                {ts}A URL to the opt-in page. Must include the tokens <code>[PROFILE]</code> and <code>[CONTACT_CHECKSUM]</code> which will be replaced with the actual contact checksum for identifying the contact. e.g.: <code>https://civi.example.com/civicrm_newsletter/optin/[PROFILE]/[CONTACT_HASH]</code>{/ts}
              </div>
            </td>
          </tr>
          ...
          <tr class="crm-section">
            ...
            <td class="content">
              ...
              <div class="description">
                {ts}A URL to the preferences form. Must include the tokens <code>[PROFILE]</code> and <code>[CONTACT_CHECKSUM]</code> which will be replaced with the actual contact checksum for identifying the contact. e.g.: <code>https://civi.example.com/civicrm_newsletter/preferences/[PROFILE]/[CONTACT_HASH]</code>{/ts}
              </div>
            </td>
          </tr>
          ...
          <tr class="crm-section">
            ...
            <td class="content">
              ...
              <div class="description">
                  {ts}A URL to the Request link form. Must include the token <code>[PROFILE]</code> and may include the token <code>[CONTACT_CHECKSUM]</code> which will be replaced with the actual contact checksum for identifying the contact. e.g.: <code>https://civi.example.comcivicrm_newsletter/request_link/[PROFILE]/[CONTACT_HASH]</code>{/ts}
              </div>
            </td>
          </tr>
